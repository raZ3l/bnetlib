...
class ItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
         $this->assertInstanceOf('bnetlib\Resource\Wow\Shared\ListData', self::$obj->getAllowableClasses());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Shared\ListData', self::$obj->getAllowableRacees());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Item\BonusStats', self::$obj->getBonusStats());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Item\Spells', self::$obj->getItemSpells());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Item\WeaponInfo', self::$obj->getWeaponInfo());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Item\SocketInfo', self::$obj->getSocketInfo());
    }
