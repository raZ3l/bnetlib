...
{
    /**
     * @var bnetlib\Resource\Wow\Character\Professions
     */
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Character\Profession', self::$obj->getById(171));
    }
    ...
    public function testIterator()
    {
        foreach (self::$obj as $key => $prof) {
            $this->assertInstanceOf('bnetlib\Resource\Wow\Character\Profession', $prof);
        }
    }
}