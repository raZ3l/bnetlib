...
use bnetlib\Resource\Wow\Character\Profession;
...
{
    /**
     * @var bnetlib\Resource\Wow\Character\Profession
     */
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Wow\Shared\ListData', self::$obj->getRecipes());
    }
