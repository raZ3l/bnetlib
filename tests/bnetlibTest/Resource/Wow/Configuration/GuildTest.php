...
use bnetlib\Resource\Wow\Configuration\Guild;
 ...
 * @license    https://gitbub.com/coss/bnetlib/LISENCE     MIT License
 */
class GuildTest extends SharedConfigurationTest
{
    /**
     * @var Guild
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Guild::RESOURCE_URL')) {
            if (!is_string(Guild::RESOURCE_URL)) {
