...
use bnetlib\Resource\Wow\Configuration\Battlegroups;
 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class BattlegroupsTest extends SharedConfigurationTest
{
    /**
     * @var Battlegroups
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Battlegroups::RESOURCE_URL')) {
            if (!is_string(Battlegroups::RESOURCE_URL)) {
