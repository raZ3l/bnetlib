...
use bnetlib\Resource\Wow\Configuration\Quest;
 ...
 * @license    https://gitbub.com/coss/bnetlib/LISENCE     MIT License
 */
class QuestTest extends SharedConfigurationTest
{
    /**
     * @var Quest
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Quest::RESOURCE_URL')) {
            if (!is_string(Quest::RESOURCE_URL)) {
