...
use bnetlib\Resource\Wow\Configuration\Recipe;
 ...
 * @license    https://gitbub.com/coss/bnetlib/LISENCE     MIT License
 */
class RecipeTest extends SharedConfigurationTest
{
    /**
     * @var Recipe
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Recipe::RESOURCE_URL')) {
            if (!is_string(Recipe::RESOURCE_URL)) {
