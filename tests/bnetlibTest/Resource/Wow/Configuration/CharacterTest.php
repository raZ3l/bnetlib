 ...
 * @license    https://gitbub.com/coss/bnetlib/LISENCE     MIT License
 */
class CharacterTest extends SharedConfigurationTest
{
    /**
     * @var Character
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Character::RESOURCE_URL')) {
            if (!is_string(Character::RESOURCE_URL)) {
