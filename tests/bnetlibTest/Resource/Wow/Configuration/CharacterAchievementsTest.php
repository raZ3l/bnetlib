...
use bnetlib\Resource\Wow\Configuration\CharacterAchievements;
...
class CharacterAchievementsTest extends SharedConfigurationTest
{
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\CharacterAchievements::RESOURCE_URL')) {
            if (!is_string(CharacterAchievements::RESOURCE_URL)) {
