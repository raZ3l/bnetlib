...
use bnetlib\Resource\Wow\Configuration\CharacterRaces;
 ...
 * @license    https://gitbub.com/coss/bnetlib/LISENCE     MIT License
 */
class CharacterRacesTest extends SharedConfigurationTest
{
    /**
     * @var CharacterRaces
     */
    ...
    {
        $this->config = new CharacterRaces();
    }
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\CharacterRaces::RESOURCE_URL')) {
            if (!is_string(CharacterRaces::RESOURCE_URL)) {
