...
use bnetlib\Resource\Wow\Configuration\GuildRewards;
 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class GuildRewardsTest extends SharedConfigurationTest
{
    /**
     * @var GuildRewards
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\GuildRewards::RESOURCE_URL')) {
            if (!is_string(GuildRewards::RESOURCE_URL)) {
