...
use bnetlib\Resource\Wow\Configuration\Achievement;
 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class AchievementTest extends SharedConfigurationTest
{
    /**
     * @var Achievement
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Achievement::RESOURCE_URL')) {
            if (!is_string(Achievement::RESOURCE_URL)) {
