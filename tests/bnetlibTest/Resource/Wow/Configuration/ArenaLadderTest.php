...
use bnetlib\Resource\Wow\Configuration\ArenaLadder;
 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class ArenaLadderTest extends SharedConfigurationTest
{
    /**
     * @var ArenaLadder
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\ArenaLadder::RESOURCE_URL')) {
            if (!is_string(ArenaLadder::RESOURCE_URL)) {
