...
use bnetlib\Resource\Wow\Configuration\Auction;
 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class AuctionTest extends SharedConfigurationTest
{
    /**
     * @var Auction
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\Auction::RESOURCE_URL')) {
            if (!is_string(Auction::RESOURCE_URL)) {
