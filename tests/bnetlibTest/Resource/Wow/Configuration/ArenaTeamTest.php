...
use bnetlib\Resource\Wow\Configuration\ArenaTeam;
 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class ArenaTeamTest extends SharedConfigurationTest
{
    /**
     * @var ArenaTeam
     */
    ...
    public function testResourceUrl()
    {
        ...
        if (defined('bnetlib\Resource\Wow\Configuration\ArenaTeam::RESOURCE_URL')) {
            if (!is_string(ArenaTeam::RESOURCE_URL)) {
