...
use bnetlib\Resource\Entity\Wow\Character\Talents;
...
{
    /**
     * @var bnetlib\Resource\Entity\Wow\Character\Talents
     */
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\TalentSpecialization', self::$obj->getFristSpec());
    }

    public function testSecoundSpec()
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\TalentSpecialization', self::$obj->getSecoundSpec());
    }

    public function testSelectedSpec()
    {
       $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\TalentSpecialization', self::$obj->getSelectedSpec());
    }
