...
use bnetlib\Resource\Entity\Wow\Character\Items;
...
{
    /**
     * @var bnetlib\Resource\Entity\Wow\Character\Items
     */
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getBack());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getChest());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getFeet());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getFirstFinger());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getSecondFinger());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getHands());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getHead());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getLegs());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getMainHand());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getOffHand());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getNeck());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getRanged());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getShirt());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getShoulder());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getFirstTrinket());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getSecondTrinket());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getWaist());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\Wow\Character\Item', self::$obj->getWrist());
    }
