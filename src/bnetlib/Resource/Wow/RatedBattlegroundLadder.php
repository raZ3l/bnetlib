 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class RatedBattlegroundLadder implements ResourceInterface, \Iterator
{
    /**
     * @var int
     */
    ...
    public function populate($data)
    {
        foreach ($data['bgRecord'] as $i => $char) {
            ...
            $this->data[$i] = $this->serviceLocator->get('wow.character.record');
    ...
    /**
     * @param  int $id
     * @return bnetlib\Resource\Wow\Character\Record|null
     */
    ...
    /**
     * @see    \Iterator
     * @return bnetlib\Resource\Wow\Character\Record
     */
