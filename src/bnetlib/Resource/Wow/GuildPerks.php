 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class GuildPerks implements ResourceInterface, \Iterator
{
    /**
     * @var int
     */
    ...
    /**
     * @param  id $level
     * @return bnetlib\Resource\Wow\Guild\Perk|null
     */
    public function getByGuildLevel($level)
    {
        if(isset($this->index[$level])) {
    ...
    /**
     * @see    \Iterator
     * @return bnetlib\Resource\Wow\Guild\Perk
     */
