 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class Hero implements ConfigurationInterface
{
    /**
     * @const string
     */
    const RESOURCE_URL = '/api/d3/account/%s/hero/%s';
     ...
     * @var array
     */
    protected $requiredArguments = array('account', 'id');

    /**
     * @var array
     */
    protected $argumentAliases = array(
        'account' => array('battletag', 'acc'),
    );
