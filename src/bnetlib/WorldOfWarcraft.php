...
class WorldOfWarcraft extends AbstractGame
{
    ...
    protected $resources = array(
        ...
        'ArenaLadder'             => 'wow.arenaladder',
        'ArenaTeam'               => 'wow.arenateam',
        'Auction'                 => 'wow.auction',
        'AuctionData'             => 'wow.auctiondata',
        'Battlegroups'            => 'wow.battlegroups',
        'Character'               => 'wow.character',
        'CharacterAchievements'   => 'wow.achievements',
        'CharacterClasses'        => 'wow.characterclasses',
        'CharacterRaces'          => 'wow.characterraces',
        'Guild'                   => 'wow.guild',
        'GuildAchievements'       => 'wow.achievements',
        'GuildPerks'              => 'wow.guildperks',
        'GuildRewards'            => 'wow.guildrewards',
        'Item'                    => 'wow.item',
        'ItemClasses'             => 'wow.itemclasses',
        'ItemSet'                 => 'wow.itemset',
        'Quest'                   => 'wow.quest',
        'RatedBattlegroundLadder' => 'wow.ratedbattlegroundladder',
        'Realms'                  => 'wow.realms',
        'Recipe'                  => 'wow.recipe',
        'Thumbnail'               => 'shared.file',
    );
